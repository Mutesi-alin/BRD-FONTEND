...
//     setPendingRequests(leaveRequests.filter((r: any) => r.status === 'pending').length);
...
//         <DashboardCard label="Total Employees" value={employeeCount} href="/admin/reports" />
//         <DashboardCard label="Pending Leave Requests" value={pendingRequests} href="/admin/leave-types" />
//         <DashboardCard label="Departments" value={departmentCount} href="/admin/calendars" />
//       </div>

//       <div className="bg-white p-4 rounded-lg shadow border">
//         <h2 className="text-lg font-semibold mb-2">Recent Activity</h2>
//         <ul className="list-disc list-inside text-gray-700">
//           <li>Alice requested annual leave.</li>
//           <li>HR added a new leave type: "Comp Off".</li>
//         </ul>
//       </div>
//     </div>
//   );
...
// const DashboardCard = ({ label, value, href }: { label: string; value: number; href: string }) => (
//   <Link href={href}>
//     <div className="cursor-pointer bg-white p-4 rounded-lg shadow border hover:bg-blue-50 transition">
